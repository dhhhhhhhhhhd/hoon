...
var dataGetUrl = "/inquiry/commentGetList/"+commmentPage; // 데이터를 가져올 링크
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            function commentGetData(page){
                var dataGetUrl = "/inquiry/commentUpdateGetData/"+page;
                $.ajax({
                    url:dataGetUrl,
                    type:"post",
                    dataType:"json",
                    success:function(data){
                        ...
                        var action = "/inquiry/commentUpdateAction/"+page;
